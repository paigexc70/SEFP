# Assignment 1 
# Looking For Near Misses
# File Name: assignment_1_JoseMontesDeOcaMorfin.py
...
max = int(input("Enter the max number you want to compare: "))      # this is k (there is no max (yet))
...
for i in range(1,max + 1):                            # Here we are going to do two loops, one to cycle every first number combination, and the next to cycle the next number combination from 1-k
    for j in range(1,max + 1):                        # this is the second number combinaiton
